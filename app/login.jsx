...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    if (!email || !password) return Alert.alert("Error", "Sila isi semua maklumat.");
    setLoading(true);
    try {
    ...
    <ThemedView safe style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.header}>
            <View style={styles.logoRing}>
                <View style={styles.logoBox}>
                    <Brain size={48} color={Colors.accent.primaryLight} strokeWidth={1.5} />
                </View>
            </View>
            <ThemedText title style={styles.title}>Cognito</ThemedText>
            <ThemedText style={styles.subtitle}>Let's warm up your brain.</ThemedText>
        </View>
        ...
        <View style={styles.form}>
            ...
            <TouchableOpacity onPress={handleLogin} disabled={loading} style={styles.shadowWrapper}>
                <LinearGradient 
        ...
        <View style={styles.footer}>
            <ThemedText style={{ color: Colors.text.secondary }}>Do not have an account? </ThemedText>
            <Link href="/register">
